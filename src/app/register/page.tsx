...
import { Lock, Mail, ChevronRight, Eye, EyeOff, ArrowLeft, User, Chrome } from "lucide-react";
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    startTransition(async () => {
      ...
      if (result?.error) {
        ...
        toast.success("Account created! Welcome to Royal NLK Silks!");
      }
    });
  };
      ...
      <div className="w-full max-w-md z-10">
        ...
        <div className="bg-white rounded-sm shadow-2xl border border-secondary/10 p-6 md:p-10 animate-fade-in">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground text-sm mt-4">Create your account to shop</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-2">
              <label className="text-xs font-bold uppercase tracking-widest text-primary flex items-center gap-2">
                <Lock size={13} className="text-secondary" /> Confirm Password
              </label>
              <input
                type="password"
